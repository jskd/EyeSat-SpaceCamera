...
alias com {
  ...
  vcom     "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_rsp_xbar_demux_001.vho"                                                     -work rsp_xbar_demux_001                                                    
  ...
  vcom     "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_id_router_001.vho"                                                          -work id_router_001                                                         
  ...
  vcom     "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent_rsp_fifo
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_slave_agent.sv"                                             -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_burst_uncompressor.sv"                                      -work onchip_memory2_0_s1_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_master_agent.sv"                                            -work CPU_data_master_translator_avalon_universal_master_0_agent            
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_slave_translator.sv"                                        -work onchip_memory2_0_s1_translator                                        
  vlog -sv "$QSYS_SIMDIR/nios_tb/simulation/submodules/mentor/altera_merlin_master_translator.sv"                                       -work CPU_data_master_translator                                            
