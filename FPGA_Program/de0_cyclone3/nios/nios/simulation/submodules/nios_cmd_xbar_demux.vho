...
--synthesis_resources = 
 ...
 ENTITY  nios_cmd_xbar_demux IS 
	 ...
	 ( 
		 ...
		 src6_data	:	OUT  STD_LOGIC_VECTOR (86 DOWNTO 0);
		 ...
		 src7_data	:	OUT  STD_LOGIC_VECTOR (86 DOWNTO 0);
 ...
 ARCHITECTURE RTL OF nios_cmd_xbar_demux IS
	 ...
	 SIGNAL  s_wire_nios_cmd_xbar_demux_wideor0_17_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_nios_cmd_xbar_demux_wideor0_17_dataout <= (((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0)) OR wire_w_lg_w_sink_channel_range21w22w(0));
	sink_ready <= s_wire_nios_cmd_xbar_demux_wideor0_17_dataout;
