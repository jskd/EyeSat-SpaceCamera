...
# ACDS 13.0sp1 232 win32 2016.06.13.14:19:20
...
alias com {
  ...
  vcom  "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_007.vho"                                                       -work rsp_xbar_demux_007                                                      
  ...
  vcom  "$QSYS_SIMDIR/submodules/nios_id_router_007.vho"                                                            -work id_router_007                                                           
  ...
  vcom  "$QSYS_SIMDIR/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo.vho" -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo
  vcom  "$QSYS_SIMDIR/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"   -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo  
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_agent.sv"                                                -work onchip_memory_s1_translator_avalon_universal_slave_0_agent              
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                         -work onchip_memory_s1_translator_avalon_universal_slave_0_agent              
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_translator.sv"                                           -work onchip_memory_s1_translator                                             
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_translator.sv"                                          -work CPU_instruction_master_translator                                       
  vcom  "$QSYS_SIMDIR/submodules/nios_cmv_transmit_data.vhd"                                                        -work cmv_transmit_data                                                       
  vcom  "$QSYS_SIMDIR/submodules/nios_spi.vhd"                                                                      -work spi                                                                     
  vcom  "$QSYS_SIMDIR/submodules/nios_sdram_controller.vhd"                                                         -work sdram_controller                                                        
  vcom  "$QSYS_SIMDIR/submodules/nios_sdram_controller_test_component.vhd"                                          -work sdram_controller                                                        
  ...
  vcom  "$QSYS_SIMDIR/nios_onchip_memory_s1_translator_avalon_universal_slave_0_agent.vhd"                                                                                                        
  vcom  "$QSYS_SIMDIR/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent.vhd"                                                                                                     
  vcom  "$QSYS_SIMDIR/nios_width_adapter.vhd"                                                                                                                                                     
  vcom  "$QSYS_SIMDIR/nios_width_adapter_001.vhd"                                                                                                                                                 
  ...
  vcom  "$QSYS_SIMDIR/nios_sdram_controller_s1_translator.vhd"                                                                                                                                    
  vcom  "$QSYS_SIMDIR/nios_data_clk_s1_translator.vhd"                                                                                                                                            
  vcom  "$QSYS_SIMDIR/nios_data_ch9_s1_translator.vhd"                                                                                                                                            
  vcom  "$QSYS_SIMDIR/nios_spi_spi_control_port_translator.vhd"                                                                                                                                   
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L width_adapter -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_007 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L id_router_007 -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory_s1_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L onchip_memory_s1_translator -L CPU_instruction_master_translator -L cmv_transmit_data -L spi -L sdram_controller -L uart -L jtag_uart -L onchip_memory -L data_clk -L CPU -L data_ctr -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L width_adapter -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_007 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L id_router_007 -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L onchip_memory_s1_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L onchip_memory_s1_translator -L CPU_instruction_master_translator -L cmv_transmit_data -L spi -L sdram_controller -L uart -L jtag_uart -L onchip_memory -L data_clk -L CPU -L data_ctr -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneiii $TOP_LEVEL_NAME
}
