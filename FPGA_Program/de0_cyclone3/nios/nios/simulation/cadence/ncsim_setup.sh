...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_rsp_xbar_demux_007.vho"                                                       -work rsp_xbar_demux_007                                                       -cdslib ./cds_libs/rsp_xbar_demux_007.cds.lib                                                      
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_id_router_007.vho"                                                            -work id_router_007                                                            -cdslib ./cds_libs/id_router_007.cds.lib                                                           
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo.vho" -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo -cdslib ./cds_libs/sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"   -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo   -cdslib ./cds_libs/sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.cds.lib  
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_cmv_transmit_data.vhd"                                                        -work cmv_transmit_data                                                        -cdslib ./cds_libs/cmv_transmit_data.cds.lib                                                       
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_spi.vhd"                                                                      -work spi                                                                      -cdslib ./cds_libs/spi.cds.lib                                                                     
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_sdram_controller.vhd"                                                         -work sdram_controller                                                         -cdslib ./cds_libs/sdram_controller.cds.lib                                                        
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/nios_sdram_controller_test_component.vhd"                                          -work sdram_controller                                                         -cdslib ./cds_libs/sdram_controller.cds.lib                                                        
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/nios_onchip_memory_s1_translator_avalon_universal_slave_0_agent.vhd"                                                                                                                                                                                                            
  ncvhdl -v93 "$QSYS_SIMDIR/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent.vhd"                                                                                                                                                                                                         
  ncvhdl -v93 "$QSYS_SIMDIR/nios_width_adapter.vhd"                                                                                                                                                                                                                                                         
  ncvhdl -v93 "$QSYS_SIMDIR/nios_width_adapter_001.vhd"                                                                                                                                                                                                                                                     
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/nios_sdram_controller_s1_translator.vhd"                                                                                                                                                                                                                                        
  ncvhdl -v93 "$QSYS_SIMDIR/nios_data_clk_s1_translator.vhd"                                                                                                                                                                                                                                                
  ncvhdl -v93 "$QSYS_SIMDIR/nios_data_ch9_s1_translator.vhd"                                                                                                                                                                                                                                                
  ncvhdl -v93 "$QSYS_SIMDIR/nios_spi_spi_control_port_translator.vhd"                                                                                                                                                                                                                                       
