...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_width_adapter.sv"                                              -work width_adapter                                                           
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_address_alignment.sv"                                          -work width_adapter                                                           
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                         -work width_adapter                                                           
  ...
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_burst_adapter.sv"                                              -work burst_adapter                                                           
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_address_alignment.sv"                                          -work burst_adapter                                                           
  ...
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_slave_agent.sv"                                                -work onchip_memory_s1_translator_avalon_universal_slave_0_agent              
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                         -work onchip_memory_s1_translator_avalon_universal_slave_0_agent              
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_master_agent.sv"                                               -work CPU_instruction_master_translator_avalon_universal_master_0_agent       
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_slave_translator.sv"                                           -work onchip_memory_s1_translator                                             
  vlog  "$QSYS_SIMDIR/nios_tb/simulation/submodules/aldec/altera_merlin_master_translator.sv"                                          -work CPU_instruction_master_translator                                       
