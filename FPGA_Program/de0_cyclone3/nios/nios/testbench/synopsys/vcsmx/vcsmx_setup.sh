...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_rsp_xbar_demux_007.vho"                                                       -work rsp_xbar_demux_007                                                      
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_id_router_007.vho"                                                            -work id_router_007                                                           
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_id_router_002.vho"                                                            -work id_router_002                                                           
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo.vho" -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"   -work sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo  
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_onchip_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo.vho"      -work onchip_memory_s1_translator_avalon_universal_slave_0_agent_rsp_fifo     
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_cmv_transmit_data.vhd"                                                        -work cmv_transmit_data                                                       
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_spi.vhd"                                                                      -work spi                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_sdram_controller.vhd"                                                         -work sdram_controller                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_sdram_controller_test_component.vhd"                                          -work sdram_controller                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_uart.vhd"                                                                     -work uart                                                                    
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_jtag_uart.vhd"                                                                -work jtag_uart                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_onchip_memory.vhd"                                                            -work onchip_memory                                                           
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/altera_sdram_partner_module.vhd"                                                   -work sdram_controller_my_partner                                             
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_onchip_memory_s1_translator_avalon_universal_slave_0_agent.vhd"               -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_sdram_controller_s1_translator_avalon_universal_slave_0_agent.vhd"            -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_width_adapter.vhd"                                                            -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_width_adapter_001.vhd"                                                        -work nios_inst                                                               
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_onchip_memory_s1_translator.vhd"                                              -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_cpu_jtag_debug_module_translator.vhd"                                         -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_sdram_controller_s1_translator.vhd"                                           -work nios_inst                                                               
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_spi_spi_control_port_translator.vhd"                                          -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_uart_s1_translator.vhd"                                                       -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_jtag_uart_avalon_jtag_slave_translator.vhd"                                   -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_rst_controller.vhd"                                                           -work nios_inst                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_tb/simulation/submodules/nios_rst_controller_001.vhd"                                                       -work nios_inst                                                               
